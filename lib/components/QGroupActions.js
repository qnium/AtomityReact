...
var QGroupActions = function (_Component) {
    ...
    function QGroupActions(props) {
        ...
        _this.checkBoxClick = function () {
            (0, _qniumEvents2.default)(_atomityFrontendCommon.ListControllerEvents.setAllChecked).send({ targetName: self.targetCtrl, data: { newState: !self.state.allChecked } });
        };
        return _this;
    }
    ...
    _createClass(QGroupActions, [{
            ...
            return _react2.default.Children.map(this.props.children.props.children, function (menuItem, index) {
                ...
                if (menuItem.type === _QAction2.default) {
                    actionTemplate = _react2.default.createElement(
                        _QAction2.default,
                        Object.assign({ disabled: !_this2.state.actionsAllowed }, menuItem.props, { val: _this2.state.checkedItems, targetListCtrlName: _this2.targetCtrl }),
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                { className: 'q-group-actions-button-group' },

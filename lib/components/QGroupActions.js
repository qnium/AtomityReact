...
var QGroupActions = function (_Component) {
    ...
    _createClass(QGroupActions, [{
        ...
        value: function renderMenuItems() {
            ...
            var subItems = this.props.children.props.children;
            if (!subItems) {
                return null;
            }

            if ((typeof subItems === 'undefined' ? 'undefined' : _typeof(subItems)) === "object" && !subItems.length) {
                subItems = [subItems];
            }

            return subItems.map(function (menuItem, index) {

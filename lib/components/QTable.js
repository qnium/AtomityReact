...
var QTable = function (_Component) {
    ...
    function QTable(props) {
        ...
        _this.handlerRemover = (0, _qniumEvents2.default)(_atomityFrontendCommon.ListControllerEvents.stateChanged).handle(function (event) {
            ...
            if (this.state.actionInProgress) {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'q-center' },
                        this.props.progressIndicator ? this.props.progressIndicator : _react2.default.createElement(_reactFontawesome2.default, { name: 'refresh', size: '3x', spin: true })
                    )
                );
            } else {
                return null;
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            this.state.pageData.map(function (pageItem, index) {
                                return _react2.default.createElement(
                                    'tr',
                                    { key: index, className: index % 2 === 0 ? this.props.evenRowClass : this.props.oddRowClass },

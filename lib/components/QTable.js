...
var QTable = function (_Component) {
    ...
    function QTable(props) {
        ...
        _this.listCtrl = new _atomityCore.ListController(_this.props);
        ...
        if (_this.props.children) {
            ...
            var tableHeader = childrenArray.filter(function (element) {
                return element.type === _QTableHeader2.default;
            });
            ...
            _this.columns = childrenArray.filter(function (element) {
                return element.type === _QColumn2.default;
            });
        }
        return _this;
    }

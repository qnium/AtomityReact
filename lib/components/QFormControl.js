...
var QFormControl = function (_React$Component) {
    ...
    _createClass(QFormControl, [{
        ...
        value: function render() {
            return _react2.default.createElement(this.props.type, Object.assign({}, this.props, { ref: this.props.inputRef, onChange: this.onChange.bind(this) }), this.props.children);
        }
    }]);

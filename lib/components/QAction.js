    ...
    _createClass(QAction, [{
        ...
        value: function doAction() {
            if (this.props.isCustomAction === true) {
                (0, _qniumEvents2.default)(_atomityCore.ListControllerEvents.customAction).send({ targetName: this.props.targetListCtrlName, data: { action: this.props.action, payload: this.props.val } });
            } else {
        ...
        value: function render() {
            ...
            if (this.props.children) {
                actionTemplate = _react2.default.createElement(
                    'span',
                    { className: this.props.className, style: { cursor: this.props.cursor || 'pointer' }, onClick: this.onClick },
                    this.props.children
                );
            } else {
                actionTemplate = _react2.default.createElement(

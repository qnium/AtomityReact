    ...
    _createClass(QAction, [{
        ...
        value: function doAction() {
            if (this.props.isCustomAction === true) {
                (0, _qniumEvents2.default)(_atomityFrontendCommon.ListControllerEvents.customAction).send({ targetName: this.props.targetListCtrlName, data: { action: this.props.action, payload: this.props.val } });
            } else {

...
var QTableHeader = function (_Component) {
    ...
    _createClass(QTableHeader, [{
        ...
        value: function componentDidMount() {
            ...
            this.handlerRemover = (0, _qniumEvents2.default)(_atomityFrontendCommon.ListControllerEvents.stateChanged).handle(function (event) {
        ...
        value: function renderChildren() {
            if (this.props.children && this.props.children.type === _QGroupActions2.default || this.props.children && this.props.children.props && this.props.children.props.groupActionsClass && this.props.children.type === this.props.children.props.groupActionsClass) {
                return _react2.default.createElement(this.props.children.props.groupActionsClass || _QGroupActions2.default, Object.assign({}, this.props, { targetListCtrlName: this.props.children.props.targetListCtrlName || this.targetCtrl }));
            } else {

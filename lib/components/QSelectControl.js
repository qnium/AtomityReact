...
var QSelectControl = function (_React$Component) {
    ...
    function QSelectControl(props) {
        ...
        if (!_this.props.entityObject[_this.props.bindingField]) {
            _this.props.entityObject[_this.props.bindingField] = {};
            _this.props.entityObject[_this.props.bindingField][_this.props.valueField] = 0;
        }
        _this.state = {
            controlValue: _this.props.entityObject[_this.props.bindingField][_this.props.valueField],
            selectOptions: []
        };
    ...
    _createClass(QSelectControl, [{
        ...
        value: function onChange(event) {
            ...
            var oldValue = this.state.selectOptions.find(function (item) {

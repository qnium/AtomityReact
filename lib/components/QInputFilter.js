...
var QInputFilter = function (_Component) {
    ...
    function QInputFilter(props) {
        ...
        var filterCtrl = new _atomityFrontendCommon.InputFilterController(_this.props);
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_FormControl2.default, { id: this.props.targetListCtrlName + this.props.filteringField, type: 'text', placeholder: this.props.placeholder, defaultValue: '', onChange: this.onChangeFilterValue })
                )
            );
        }
    }]);

...
var QForm = function (_React$Component) {
    ...
    function QForm(props) {
        ...
        _this.cancel = function () {
            self.closeDialog();
            self.props.onDialogClose({ dialogResult: _atomityFrontendCommon.DialogResult.cancel });
        };
        ...
        _this.doAction = function () {
            if (self.props.entitiesName && self.props.okAction) {
                ...
                self.dataProvider.executeAction(self.props.entitiesName, self.props.okAction, entityObject).then(function (result) {
                    self.closeDialog();
                    self.props.onDialogClose({ dialogResult: _atomityFrontendCommon.DialogResult.ok, entityObject: self.props.entityObject });
                ...
                self.closeDialog();
                self.props.onDialogClose({ dialogResult: _atomityFrontendCommon.DialogResult.ok });
            }
        };
        ...
        _this.ok = function () {
            if (self.props.disableConfirmation === true) {
                ...
                _atomityFrontendCommon.DialogService.showDialog(_ActionConfirmationForm2.default).then(function (result) {
                    if (result.dialogResult === _atomityFrontendCommon.DialogResult.ok) {
                        self.doAction();
                    }
                });
            }
...
exports.DialogResult = _atomityFrontendCommon.DialogResult;

...
var QForm = function (_React$Component) {
            ...
            if (self.props.entitiesName && self.props.okAction) {
                ...
                self.dataProvider.executeAction(self.props.entitiesName, self.props.okAction, entityObject).then(function (result) {
                    ...
                    if (err.errorCode != -177) {
                        var hResult = self.dataProvider.errorHandler(err.error, err);
                        if (hResult) {
                            _this2.closeDialog();
                        }
                    } else {
    ...
    _createClass(QForm, [{
        ...
        value: function renderRecursively(children, index) {
            ...
            if ((typeof children === 'undefined' ? 'undefined' : _typeof(children)) === "object" && children.length !== undefined) {
                return children.map(function (child, index) {
                    return _this3.renderRecursively(child, index);
                });
            }
        ...
        value: function render() {
            return _react2.default.createElement(
                _Modal2.default,
                { show: this.state.showDialog, onHide: this.cancel, backdrop: this.props.backdrop != undefined ? this.props.backdrop : 'static' },
                this.renderOverlay(),
                _react2.default.createElement(
                    'div',
                    null,
                    ...
                    this.props.hideCancelButton && this.props.hideOkButton ? null : _react2.default.createElement(
                        _Modal2.default.Footer,
                        null,
                        this.props.hideCancelButton ? null : _react2.default.createElement(
                            _Button2.default,
                            { onClick: this.cancel },
                            this.props.cancelButtonText || "Cancel"
                        ),
                        this.props.hideOkButton ? null : _react2.default.createElement(
                            _Button2.default,

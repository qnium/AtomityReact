...
var QColumn = function (_Component) {
    ...
    _createClass(QColumn, [{
        ...
        value: function renderRecursively(children, index) {
            ...
            if (children.type === _QRowChecker2.default || children.props && children.props.rowCheckerClass && children.type === children.props.rowCheckerClass) {
                return _react2.default.createElement(children.props.rowCheckerClass || _QRowChecker2.default, Object.assign({}, children.props, {

...
var DialogService = {
    showDialog: function showDialog(dialog, dialogData, parentElement) {
        ...
        return new Promise(function (onDialogClose) {
            ...
            _reactDom2.default.render(_react2.default.createElement(dialog, { val: dialogData, onDialogClose: onDialogClose }), dialogContainer);
        });
    }
};
